                 ...
                 tabPanel("Meet the Team", 
                          ...
                          fluidRow(style = "margin-left: 100px; margin-right: 100px;",
                                   column(6, align = "center",
                                          ...
                                          img(src = "Sareth_Moy.jpg", style = "display: inline; border: 1px solid #C0C0C0;", width = "200px"),
                                   ...
                                   column(6, align = "center",
                                          ...
                                          img(src = "Michael_Carey.jpg", style = "display: inline; border: 1px solid #C0C0C0;", width = "150px"),
                                          br(),
