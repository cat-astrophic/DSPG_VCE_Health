...
# 🚩: Wrong position here, the position of the agent location should change in response to the argument in the function "One", "two" etc
...
# 🚩: the name for the arguments should be consistently used in the function part, case sensitive as Zscore_Type should used as Zscore_Type not zscore_type; and they are used in the wrong places
    ...
    leaflet(data = territory.counties) %>%
      ...
      addPolygons(fillColor = ~pal(Agent),
                  ...
                  labelOptions = labelOptions(style = list("font-weight" = "normal", padding = "3px 8px"),
                                              textsize = "15px",
                                              direction = "auto")) %>%
      #🚩:uisng new_agent instead of NewAgent, be careful of the names in your dataframe
