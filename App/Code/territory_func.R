...
territory <- function(territory_type, zscore_type, variable_title) {
  ...
  #                                "burlywood","dodgerblue", "honeydew","orange","hotpink","chocolate", "darkorchid1"),
  #                    
  #                               levels= c( "Albemarle",  "Amelia", "Amherst",    "Arlington",  "Bedford",    "Chesapeake City",  "Fairfax",
  #                                           "Floyd", "Franklin",   "Gloucester","Greensville","Henrico", "King George","Lancaster", 
  #                                           "Lee", "Loudoun", "Louisa", "Lynchburg City",  "Mecklenburg","Newport News City",       
  #                                           "Newport News City North",  "Orange", "Patrick",    "Petersburg City", "Pittsylvania",  "Pulaski",   
  #                                           "Richmond City",  "Roanoke", "Rockbridge", "Rockingham", "Spotsylvania", "Virginia Beach City"      
  #                                           , "Virginia Beach City North", "Warren", "Washington", "Northeast District Office", "Augusta",    
  #                                           "Essex", "Frederick",  "Prince William"))
  # 
