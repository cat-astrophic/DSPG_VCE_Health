...
#territory function
  ...
  sdoh_line <- function(county1, county2, county4, variable) {
    ...
    selection4 <- va_avg[va_avg$County2 == county4 & va_avg$Variable == variable, ]%>% 
      na.omit(cols= Value)
    ...
    comparison_plot <- plot_ly() %>%
      ...
      add_trace(data = avg, x = ~Year, y = ~Value, name = "State Average",
                type = "scatter", mode = "lines", 
                line = list(color = "#2A788EFF", width = 4)) %>%
                                      ...
                                      tabPanel("SNAP-Ed Agents",
                                                ...
                                                fluidRow(
                                                  ...
                                                  column(4,
                                                         ...
                                                         selectInput("zscore_type_snaped", "Health Variables",
                                                                     choices = c("Aggregate" = "aggregate",
                                                                                 "Food Insecurity" = "food",
                                                                                 "Obesity" = "obese",
                                                                                 "Low Birthweight" = "lowbirth",
                                      ...
                                      tabPanel("FCS Agents",
                                               ...
                                               fluidRow(
                                                 ...
                                                 column(4,
                                                        ...
                                                        selectInput("zscore_type_non_snaped", "Health Variables",
                                                                    choices = c("Aggregate" = "aggregate",
                                                                                "Food Insecurity" = "food",
                                                                                "Obesity" = "obese",
                                                                                "Low Birthweight" = "lowbirth",
