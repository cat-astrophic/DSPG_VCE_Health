                 ...
                 tabPanel("Meet the Team", 
                          ...
                          fluidRow(style = "margin-left: 100px; margin-right: 100px;",
                                   column(6, align = "center",
                                          ...
                                          p(a(href = 'https://www.linkedin.com/in/sarethmoy90/', 'Sareth Moy', target = '_blank'), "(Berea College, Undergraduate in Economics);",
                                            br(), 
                                            a(href = 'https://www.linkedin.com/in/vivian-peregrino-284172227/', 'Vivian Peregrino', target = '_blank'), "(Virginia Tech, Undergraduate in Environmental Economics, Management, and Policy);",
                                            br(),
